...
export default {
      ...
      if (connInfo) {
        ...
        this._engineCall(
          ...
          (engine, connection, nodeData, onSuccess, onFail)=>{
            ...
            engine.executeQuery(undefined, query, connection, nodeData, onSuccess);
          }
        );
  ...
  _engineCall(nodeInfo, callback) {
    ...
    if (nodeInfo.node && engine) {
      ...
      callback(engine, nodeInfo.connection, nodeData, onSuccess, onFail);
    }
  },
