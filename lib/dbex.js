...
import ResultList from './view/result-list';
...
export default {
  ...
  activate() {
    ...
    this.resultList1 = new ResultList({name:'dbex-result-1', title:'Query Result 01', icon:'icon-table'})
    this.resultList2 = new ResultList({name:'dbex-result-2', title:'Query Result 02', icon:'icon-table'})
