...
export default class CreateConnection {
  ...
  render() {
          ...
          <div class="control-group">
            <div class="controls">
              ...
              <div class="controls" style="display:flex;">
                <div style="flex:1;" class="editor-container">
                </div>
                <div style="margin-left: 10px;" class="dbex-color-picker">
                </div>
              </div>
            </div>
            <div>
    ...
    colorPickerArea.appendChild(this.colorPicker.element);
    this.disposables.add(this.colorPicker);
  ...
  setSelectedColor(colorCode) {
    // console.log('---->', colorCode, this.colorPicker);
    this.colorPicker.setColorCode(colorCode);
  }
  ...
  getFormData() {
    ...
    fields.color = this.colorPicker.getSelectedColor();
  ...
  show(engines, defaultName) {
    if (!this.dialogPanel) {
      ...
      console.log('this.dialogPanel', this.dialogPanel);
    }
  }
