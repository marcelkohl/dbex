  ...
  render() {
    ...
    dialogElement.innerHTML = `
      <section class='dbex dialog'>
        <div class='heading section-heading'>Connection Info</div>
            ...
            <div>
              <div class="controls">
                <label class="control-label">
                  ...
                  <select tabindex="2" id="engine" class="form-control connection-engine" data-original-title="" title="">
                  </select>
              </div>
            </div>
    ...
    this._connNameEditor.element.tabIndex = 0;
  ...
  setCustomFields(fields, values) {
    ...
    fields.forEach((field, index) => {
      ...
      if (field.isBool) {
        ...
        editElement.element.tabIndex = index + this._tabIndexStart;
      ...
      customLine.appendChild(el);

      if ((index % 2) || totalFields === (index-1)) {
        customFieldsArea.appendChild(customLine);
      }
    });
  }
